...
export const reviews: TReviews = {
  ...
  "IGN Middle East": {
    review:
      'After a lot of waiting, FromSoftware was able to pour their many years of experience into Elden Ring, and with the participation of famous writer "George Martin" on the story front, we now have the best Souls game ever.',
    rating: "9 / 10.0",
  },
  "IGN Italy": {
    review:
  ...
  "GRYOnline.pl": {
    review:
      "Dark Souls... Dark Souls never changes. Are you sure? Because although Elden Ring draws handfuls from the achievements and mechanics of its predecessors, it contains many novelties – including this one, monumental, called the open world. Painful as never before.",
    rating: "9.5 / 10.0",
  },
  "Paste Magazine": {
    review:
  ...
  Gamersky: {
    review:
      "Elden Ring has created an epic and magnificent world, reaching the top of the series in terms of the breadth of the map and the depth of the battle system.",
    rating: "9.8 / 10.0",
  },
  Impulsegamer: {
    review:
  ...
  "Oyungezer Online": {
    review:
      'A beauty that says "don\'t be afraid" to those who are afraid of souls games, and the cons are controversial.',
    rating: "9 / 10.0",
  },
  Softpedia: {
    review:
  ...
  TrueGaming: {
    review:
      "Elden Ring sets new standards for open world content, and takes the series to new horizons that only make us more eager for what its future might hold.",
    rating: "10 / 10.0",
  },
  "Pure Xbox": {
    review:
  ...
  Gamefa: {
    review:
      "Elden Ring receives the legacy left by Breath of the Wild and promotes it by adding its Souls-Like formula.",
    rating: "10 / 10.0",
  },
  GameSkinny: {
    review:
  ...
  Zoomg: {
    review:
      "It's an almost perfect package where the variety of combat methods varies thanks to the skills of weapons and spells.",
    rating: "9.5 / 10.0",
  },
  "Saudi Gamer": {
    review:
      "A successful new direction, adding some improvements while offering a large open world full of secrets.",
    rating: "9 / 10",
  },
  LevelUp: {
    review:
  ...
  Unboxholics: {
    review:
      "The Elden Ring, at first, fails to describe itself and you feel that it is losing part of the Souls temperament but very quickly it gives you the biggest awareness slap you have received from a video game. Until you recover, you have entered deeply and violently into the most important and immersive world that the medium has known in recent years.",
    rating: "Masterpiece",
  },
  "Saving Content": {
    review:
