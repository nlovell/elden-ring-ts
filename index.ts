...
type aboutGame = {title: string, genre: string, release: string, developer: string, platforms: string[], awards: string[], writers: string[], directors: string[], composers: string[], publishers: string[]};
